...
export const getVersion = (f, options) => fetchWithRetryDelay(location.hostname === 'localhost' || location.hostname === '127.0.0.1' ? 'https://emuos.emupedia.net/emuos/version.json' : '/emuos/version.json', options, f)