const p = [
  "/emuos/immutable/start-9c68a4b6.js",
  ...
  "/emuos/immutable/pages/index.svelte-343c0d44.js",
...
], i = "1661111839381", r = `cache${i}`, m = p.concat(l.filter((s) => !s.startsWith("/_config.yml") && !s.startsWith("/CNAME") && !s.startsWith("/manifest.json"))), d = new Set(m);
