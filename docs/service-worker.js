const p = [
  "/emuos/immutable/start-501a3215.js",
...
], i = "1661247785887", r = `cache${i}`, m = p.concat(l.filter((s) => !s.startsWith("/_config.yml") && !s.startsWith("/CNAME") && !s.startsWith("/manifest.json"))), d = new Set(m);
