const p = [
  "/emuos/immutable/start-a34cad30.js",
...
], i = "1661114312330", r = `cache${i}`, m = p.concat(l.filter((s) => !s.startsWith("/_config.yml") && !s.startsWith("/CNAME") && !s.startsWith("/manifest.json"))), d = new Set(m);
