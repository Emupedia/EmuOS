const p = [
  "/emuos/immutable/start-cffa8b32.js",
  ...
  "/emuos/immutable/pages/index.svelte-a7f54468.js",
...
], i = "1661112171485", r = `cache${i}`, m = p.concat(l.filter((s) => !s.startsWith("/_config.yml") && !s.startsWith("/CNAME") && !s.startsWith("/manifest.json"))), d = new Set(m);
