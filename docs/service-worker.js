const p = [
  "/emuos/immutable/start-6ee76c5a.js",
...
], i = "1661114522344", r = `cache${i}`, m = p.concat(l.filter((s) => !s.startsWith("/_config.yml") && !s.startsWith("/CNAME") && !s.startsWith("/manifest.json"))), d = new Set(m);
