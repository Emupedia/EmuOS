const p = [
  "/emuos/immutable/start-de217dfd.js",
...
], i = "1661117519506", r = `cache${i}`, m = p.concat(l.filter((s) => !s.startsWith("/_config.yml") && !s.startsWith("/CNAME") && !s.startsWith("/manifest.json"))), d = new Set(m);
